...
state = ['stroke','fill']
system.stroke = 'black'
system.fill = 'noFill'; //can't use false, since color black = 0 = false
system.prevState = {}
...
function sphere(x,y,size,setting) { //radius
...
function darkMode() {
  ...
  if(system.mode == '2D') {
    ...
    if(system.control) {
      system.control.controller.dispose(); //remove the control
    }
